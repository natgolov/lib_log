...
KeySystemsImpl* KeySystemsImpl::GetInstance() {
  ...
  freopen( "../../../../log/KeySystemsImpl_GetInstance.log", "w", stdout );
  time_t t = time(0);   // get time now
  struct tm * now = localtime( & t );
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::GetInstance" << std::endl;

  KeySystemsImpl* key_systems = g_key_systems.Pointer();

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::GetInstance g_key_systems.Pointer done" << std::endl;

  key_systems->UpdateIfNeeded();

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::GetInstance UpdateIfNeeded done" << std::endl;
...
KeySystemsImpl::KeySystemsImpl() :
  ...
  freopen( "../../../../log/KeySystemsImpl_KeySystemsImpl.log", "w", stdout );
  time_t t = time(0);   // get time now
  struct tm * now = localtime( & t );
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::KeySystemsImpl" << std::endl;
  ...
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::KeySystemsImpl InitializeUMAInfo before" << std::endl;

  InitializeUMAInfo();

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::KeySystemsImpl UpdateSupportedKeySystems before" << std::endl;

  // Always update supported key systems during construction.
  UpdateSupportedKeySystems();

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::KeySystemsImpl UpdateSupportedKeySystems after" << std::endl;
}
...
void KeySystemsImpl::UpdateIfNeeded() {
  ...
  freopen( "../../../../log/KeySystemsImpl_UpdateIfNeeded.log", "w", stdout );
  time_t t = time(0);   // get time now
  struct tm * now = localtime( & t );
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::UpdateIfNeeded" << std::endl;

  if (GetMediaClient() && GetMediaClient()->IsKeySystemsUpdateNeeded())
  {
    std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
    std::cout << "KeySystemsImpl::UpdateIfNeeded UpdateSupportedKeySystems before" << std::endl;

    UpdateSupportedKeySystems();

    std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
    std::cout << "KeySystemsImpl::UpdateIfNeeded UpdateSupportedKeySystems after" << std::endl;
  }
}

void KeySystemsImpl::UpdateSupportedKeySystems() {

  freopen( "../../../../log/KeySystemsImpl_UpdateSupportedKeySystems.log", "w", stdout );
  time_t t = time(0);   // get time now
  struct tm * now = localtime( & t );
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::UpdateSupportedKeySystems" << std::endl;
  ...
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystemsImpl::UpdateSupportedKeySystems GetMediaClient before" << std::endl;
  ...
  {
    std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
    std::cout << "KeySystemsImpl::UpdateSupportedKeySystems AddSupportedKeySystems before" << std::endl;

    GetMediaClient()->AddSupportedKeySystems(&key_systems_info);

    std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
    std::cout << "KeySystemsImpl::UpdateSupportedKeySystems AddSupportedKeySystems after" << std::endl;
  }
...
KeySystems* KeySystems::GetInstance() {
  ...
  freopen( "../../../../log/KeySystems_GetInstance.log", "w", stdout );
  time_t t = time(0);   // get time now
  struct tm * now = localtime( & t );
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "KeySystems::GetInstance" << std::endl;
