...
freopen( "../../../../../log/AddPepperBasedWidevine.log", "w", stdout );
time_t t = time(0);   // get time now
struct tm * now = localtime( & t );
std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
std::cout << "AddPepperBasedWidevine" << std::endl;

#if defined(WIDEVINE_CDM_MIN_GLIBC_VERSION)

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddPepperBasedWidevine defined(WIDEVINE_CDM_MIN_GLIBC_VERSION)" << std::endl;
  ...
  if (!IsPepperCdmAvailable(kWidevineCdmPluginMimeType,
    ...
    std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
    std::cout << "AddPepperBasedWidevine Widevine CDM is not currently available." << std::endl;

    return;
  }

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddPepperBasedWidevine GetSupportedCodecsForPepperCdm before" << std::endl;
  ...
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddPepperBasedWidevine EME_CODEC_NONE" << std::endl;
  ...
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddPepperBasedWidevine EME_CODEC_WEBM_OPUS" << std::endl;

  supported_codecs |= media::EME_CODEC_WEBM_VORBIS;

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddPepperBasedWidevine EME_CODEC_WEBM_VORBIS" << std::endl;

#if defined(USE_PROPRIETARY_CODECS)
  supported_codecs |= media::EME_CODEC_MP4_AAC;
  
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddPepperBasedWidevine EME_CODEC_MP4_AAC" << std::endl;
  ...
  for (size_t i = 0; i < codecs.size(); ++i) {
    if (codecs[i] == kCdmSupportedCodecVp8)
    {
      ...
      std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
      std::cout << "AddPepperBasedWidevine EME_CODEC_WEBM_VP8" << std::endl;
    }
    if (codecs[i] == kCdmSupportedCodecVp9)
    {
      ...
      std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
      std::cout << "AddPepperBasedWidevine EME_CODEC_WEBM_VP9" << std::endl;
    }
#if defined(USE_PROPRIETARY_CODECS)
    if (codecs[i] == kCdmSupportedCodecAvc1)
    {
      ...
      std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
      std::cout << "AddPepperBasedWidevine EME_CODEC_MP4_AVC1" << std::endl;
    }
#endif  // defined(USE_PROPRIETARY_CODECS)
  }

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddPepperBasedWidevine cdm::AddWidevineWithCodecs before" << std::endl;
  ...
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddPepperBasedWidevine cdm::AddWidevineWithCodecs after" << std::endl;
}
...
freopen( "../../../../../log/AddChromeKeySystems.log", "w", stdout );
time_t t = time(0);   // get time now
struct tm * now = localtime( & t );
std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
std::cout << "AddChromeKeySystems" << std::endl;

#if defined(ENABLE_PEPPER_CDMS)
  AddExternalClearKey(key_systems_info);

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddChromeKeySystems defined(ENABLE_PEPPER_CDMS)" << std::endl;

#if defined(WIDEVINE_CDM_AVAILABLE)

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddChromeKeySystems defined(WIDEVINE_CDM_AVAILABLE)" << std::endl;
  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddChromeKeySystems AddPepperBasedWidevine before" << std::endl;

  AddPepperBasedWidevine(key_systems_info);

  std::cout << t << ' ' << now->tm_hour << ':' << now->tm_min << ':' << now->tm_sec << ' ';
  std::cout << "AddChromeKeySystems AddPepperBasedWidevine after" << std::endl;
